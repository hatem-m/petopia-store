    ...
    <div class="container">
      <div class="products">
        <div class="upper-content m-0">
          <p class="m-0 ps-1">{{ productsConfig.heading }}</p>
          <p class="m-0 ps-1">{{ productsConfig.pargraph }}</p>
        </div>
        <div
          class="lower-content row m-0"
...
.upper-content {
  background-image: url("@/assets/images/products/2148949611.jpg");
